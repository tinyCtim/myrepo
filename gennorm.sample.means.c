//==================================================== file = gennorm.c =====
//=  Program to generate nomally distributed random variables              =
//===========================================================================
...
// lrb - modified to generate 10000 means from samples of size 22
// predicted probability of number of means >= 93.6 is .1113

//----- Include files -------------------------------------------------------
#include <stdio.h>              // Needed for printf()
#include <stdlib.h>             // Needed for exit() and ato*()
#include <math.h>               // Needed for sqrt() and log()
#include <string.h>             // Needed for strcpy() - lrb
...
//  fprintf(fp_out, "%f \n", total / sample_size);
    fprintf(fp_out, "%d\n", (int)(total / sample_size));  // lrb 5/19,21/23
    if (total / sample_size >= 93.6) count++;
    total = 0;
	}
  }
...
// Output message and close the distribution and output files
  ...
  printf("\nThe number of means that were >= 93.6 : %d\n", count);
  printf("-------------------------------------------------------- \n");
  printf("-  Done! \n");
  printf("-------------------------------------------------------- \n");
  fclose(fp_out);
  system("./tc christian.tc -q"); // 5/21/23
}
